    ...
    <div className='w-full py-12 '>
        ...
        <div className='container mx-auto flex gap-24  mt-12 justify-center items-center'>
          <div className='text-[#5D4FC4] flex justify-center items-center gap-2'>
            ...
            <input value={email} onChange={(e) => setEmail(e.target.value)} type='email' className='border-2 px-4 w-[300px] shadow-xl rounded-xl resize-none p-2 outline-none' placeholder="Write you'r email here..." />
          </div>
          ...
          <div className='text-[#5D4FC4] flex justify-center items-center gap-2'>
            ...
            <input value={phone} onChange={(e) => setPhone(e.target.value)} type='text' className='border-2 px-4 w-[300px] shadow-xl rounded-xl resize-none p-2 outline-none' placeholder="Write you'r phone here..." />
          </div>
        </div>
